...
function submitArtist(){
    ...
    let full_name = document.getElementById("add_name").value 
    ...
    let description_node = document.createTextNode(document.getElementById("add_description").value)
    image_item.setAttribute("src",document.getElementById("add_url").value);
    ...
    myStorage.setItem(myStorage.length,JSON.stringify(saveobject))
